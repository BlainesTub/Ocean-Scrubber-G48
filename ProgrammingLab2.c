...
#pragma config(Motor,  port1,           motor1,        tmotorVex393_HBridge, openLoop, driveRight, encoderPort, I2C_1)
#pragma config(Motor,  port10,          motor2,        tmotorVex393_HBridge, openLoop, driveRight, encoderPort, I2C_2)
